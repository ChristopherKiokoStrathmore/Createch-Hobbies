      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/50 text-sm leading-relaxed max-w-xs font-inter">
              DIY assembly kits that turn every child into a builder, inventor, and engineer. Based in Nairobi, Kenya.
            </p>
            <div className="mt-6 space-y-2">
              <a
                ...
                className="inline-flex items-center gap-2 bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/30 text-[#25D366] px-4 py-2 rounded-full text-sm font-semibold transition-colors"
              >
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              <h3 className="font-playfair font-bold text-brand-yellow text-sm uppercase tracking-widest mb-5">
                {title}
              </h3>
        ...
        <div className="mt-12 pt-8 border-t border-brand-yellow/10 flex flex-col sm:flex-row items-center justify-between gap-4">
