  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Checkout online and pay instantly with M-Pesa. Pick your neighbourhood at checkout to see your exact delivery fee up front, then we deliver to your door across Nairobi in 1–2 business days.",
      },
      {
