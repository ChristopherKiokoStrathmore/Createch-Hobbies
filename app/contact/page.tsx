      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-14">
          ...
          <h1 className="font-playfair font-bold text-5xl text-white mt-5 mb-4">
            Let&apos;s <em className="text-gradient not-italic">Talk</em>
          </h1>
          <p className="text-white/45 text-lg font-inter">
            Questions about a kit? Need help choosing the right one? We&apos;re here.
          </p>
        </div>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(37,211,102,0.08) 0%, rgba(18,140,78,0.05) 100%)",
        ...
        >
          ...
          <p className="text-white/45 mb-7 text-sm font-inter">
            We&apos;re on WhatsApp all day. Most messages get a response within minutes.
          </p>
          <a
            href={whatsappGeneralLink()}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold px-8 py-4 rounded-full text-base transition-all hover:shadow-xl hover:shadow-green-500/20 font-inter"
          >
