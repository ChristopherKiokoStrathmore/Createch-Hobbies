    ...
    <section className="section-base py-14 sm:py-28 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          className="relative rounded-3xl p-7 sm:p-12 text-center overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold text-base sm:text-lg px-8 py-3.5 sm:px-10 sm:py-4 rounded-full transition-all hover:shadow-2xl hover:shadow-green-500/25 hover:-translate-y-0.5 active:scale-95"
            >
