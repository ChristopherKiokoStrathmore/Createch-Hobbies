...
export default function HeroVideo() {
  return (
    /*
     * The actual video lives in VideoBackground (fixed, z:-1) in layout.tsx.
     * This section is just the hero CONTENT and its gradient overlays.
     * position:sticky pins it to the top so subsequent sections scroll OVER it
     * while the fixed video continues playing behind everything.
     */
    <section
      className="sticky top-0 h-screen flex items-center justify-center overflow-hidden"
      style={{ zIndex: 1 }}
    >
      {/* Strong gradient overlay — makes hero text crisp */}
      <div
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto pt-20">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2.5 bg-white/8 backdrop-blur-md border border-brand-yellow/20 rounded-full px-5 py-2 mb-8 text-sm font-inter text-white/80"
        >
        ...
        <motion.h1
          ...
          className="font-playfair font-black text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] text-white leading-[1.04] mb-6 tracking-tight"
        >
          Build Something{" "}
        ...
        <motion.p
          ...
          className="text-white/60 text-lg sm:text-xl md:text-2xl max-w-2xl mx-auto mb-10 leading-relaxed font-inter"
        >
        ...
        >
          <Link
            href="/shop"
            className="btn-yellow px-9 py-4 rounded-full text-base active:scale-95"
          >
            Shop All Kits →
          </Link>
          <a
            ...
            className="inline-flex items-center justify-center gap-2 border border-white/20 hover:border-brand-yellow/35 bg-white/5 backdrop-blur-sm hover:bg-white/10 text-white font-semibold px-9 py-4 rounded-full text-base transition-all hover:-translate-y-0.5 font-inter"
          >
